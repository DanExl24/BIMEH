...
### Flujo Principal
1. El usuario accede a la vista de **Reportes** (`ReportesView.vue`).
2. En la tarjeta "Descarga Rápida de Reporte Diario", selecciona la fecha en el calendario.
3. El usuario presiona el botón **"Descargar Excel"** (o PDF/CSV).
4. El frontend dispara una petición `GET /api/exportar/excel?tipo=dia&fecha=YYYY-MM-DD`.
