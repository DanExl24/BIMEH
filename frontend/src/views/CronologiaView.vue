...
import CronologiaActivityCalendar from '../components/cronologia/CronologiaActivityCalendar.vue'
import CronologiaMonthlyMetrics from '../components/cronologia/CronologiaMonthlyMetrics.vue'
import CronologiaDailyReportTable from '../components/cronologia/CronologiaDailyReportTable.vue'
import CronologiaMonthlyHeatmapMatrix from '../components/cronologia/CronologiaMonthlyHeatmapMatrix.vue'
