<template>
  <div class="glass-panel p-5 sm:p-6 rounded-3xl flex flex-col justify-between hover:border-cyan-500/40 transition-all duration-300 group border border-darkBorder shadow-xl">
    ...
    <div class="grid grid-cols-3 gap-1.5 sm:gap-2.5 mt-6 pt-4 border-t border-darkBorder/60">
      <button 
        type="button"
        @click="reportStore.downloadReport(excelUrl, `${title} (Excel)`, 'excel')"
        class="flex items-center justify-center gap-1 sm:gap-1.5 text-center px-1.5 sm:px-3 py-2 sm:py-2.5 rounded-xl text-[11px] sm:text-xs font-bold uppercase transition-all duration-200 border cursor-pointer select-none shadow-sm bg-emerald-500/15 border-emerald-500/30 text-emerald-300 hover:bg-emerald-500/25 hover:border-emerald-500/50 active:scale-95"
      >
      ...
      <button 
        ...
        class="flex items-center justify-center gap-1 sm:gap-1.5 text-center px-1.5 sm:px-3 py-2 sm:py-2.5 rounded-xl text-[11px] sm:text-xs font-bold uppercase transition-all duration-200 border cursor-pointer select-none shadow-sm bg-darkBg border-slate-700 text-slate-300 hover:text-white hover:border-slate-500 active:scale-95"
      >
      ...
      <button 
        ...
        class="flex items-center justify-center gap-1 sm:gap-1.5 text-center px-1.5 sm:px-3 py-2 sm:py-2.5 rounded-xl text-[11px] sm:text-xs font-bold uppercase transition-all duration-200 border cursor-pointer select-none shadow-sm bg-cyan-500/15 border-cyan-500/30 text-cyan-300 hover:bg-cyan-500/25 hover:border-cyan-500/50 active:scale-95"
      >
